...
#    Updated: 2017/02/10 16:04:15 by rramirez         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_atoi.c ./ft_bzero.c ./ft_isalnum.c ./ft_isascii.c ./ft_isdigit.c\
	...
	./ft_strjoin.c ./ft_strlcat.c ./ft_strlen.c ./ft_strmap.c ./ft_strncat.c\
   	...
   	./ft_tolower.c ./ft_toupper.c ./ft_word_count.c
...
OS = ./ft_atoi.o ./ft_bzero.o ./ft_isalnum.o ./ft_isascii.o ./ft_isdigit.o\
	...
	./ft_strjoin.o ./ft_strlcat.o ./ft_strlen.o ./ft_strmap.o ./ft_strncat.o\
	...
	./ft_tolower.o ./ft_toupper.o ./ft_word_count.o
